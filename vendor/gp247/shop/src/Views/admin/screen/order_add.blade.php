                ...
                <div class="card-header with-border">
                    ...
                    <div class="card-tools">
                        <div class="btn-group float-right" style="margin-right: 5px">
                            <a href="{{ gp247_route_admin('admin_order.index') }}" class="btn  btn-flat btn-default" title="List"><i class="fa fa-list"></i><span class="hidden-xs"> {{ gp247_language_render('admin.back_list') }}</span></a>
                        </div>
                    </div>
                </div>
                <!-- /.card-header -->
                ...
                <form action="{{ gp247_route_admin('admin_order.post_create') }}" method="post" accept-charset="UTF-8" class="form-horizontal" id="form-main">
                    ...
                    <div class="card-body">
                            ...
                            <div class="form-group row {{ $errors->has('customer_id') ? ' text-red' : '' }}">
                                <label for="customer_id" class="col-sm-2 asterisk col-form-label">{{ gp247_language_render('admin.order.select_customer') }}</label>
                                <div class="col-sm-8">
                                ...
                                <div class="input-group-append">
                                    <a href="{{ gp247_route_admin('admin_customer.index') }}"><button type="button" id="button-filter" class="btn btn-success  btn-flat"><i class="fa fa-plus" title="Add new"></i></button></a>
                                </div>
                            </div>

                            <div class="form-group row {{ $errors->has('email') ? ' text-red' : '' }}" id="email">
                                <label for="email" class="col-sm-2 col-form-label">{{ gp247_language_render('order.email') }}</label>
                                <div class="col-sm-8">
                            ...
                            <div class="form-group row {{ $errors->has('first_name') ? ' text-red' : '' }}">
                                <label for="first_name" class="col-sm-2 col-form-label">{{ gp247_language_render('order.first_name') }}</label>
                                <div class="col-sm-8">
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text"><i class="fas fa-pencil-alt"></i></span>
                        ...
                        @if (gp247_config_admin('customer_lastname'))
                            <div class="form-group row {{ $errors->has('last_name') ? ' text-red' : '' }}">
                                <label for="last_name" class="col-sm-2 col-form-label">{{ gp247_language_render('order.last_name') }}</label>
                                <div class="col-sm-8">
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text"><i class="fas fa-pencil-alt"></i></span>
                        ...
                        @if (gp247_config_admin('customer_name_kana'))
                            <div class="form-group row {{ $errors->has('first_name_kana') ? ' text-red' : '' }}">
                                <label for="first_name_kana" class="col-sm-2 col-form-label">{{ gp247_language_render('order.first_name_kana') }}</label>
                                <div class="col-sm-8">
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text"><i class="fas fa-pencil-alt"></i></span>
                            ...
                            <div class="form-group row {{ $errors->has('last_name_kana') ? ' text-red' : '' }}">
                                <label for="last_name_kana" class="col-sm-2 col-form-label">{{ gp247_language_render('order.last_name_kana') }}</label>
                                <div class="col-sm-8">
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text"><i class="fas fa-pencil-alt"></i></span>
                        ...
                        @if (gp247_config_admin('customer_company'))
                            <div class="form-group row {{ $errors->has('company') ? ' text-red' : '' }}">
                                <label for="company" class="col-sm-2 col-form-label">{{ gp247_language_render('order.company') }}</label>
                                <div class="col-sm-8">
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text"><i class="fas fa-pencil-alt"></i></span>
                        ...
                        @if (gp247_config_admin('customer_postcode'))
                            <div class="form-group row {{ $errors->has('postcode') ? ' text-red' : '' }}">
                                <label for="postcode" class="col-sm-2 col-form-label">{{ gp247_language_render('order.postcode') }}</label>
                                <div class="col-sm-8">
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text"><i class="fas fa-pencil-alt"></i></span>
                        ...
                        @endif
                            ...
                            <div class="form-group row {{ $errors->has('address1') ? ' text-red' : '' }}">
                                <label for="address1" class="col-sm-2 col-form-label">{{ gp247_language_render('order.address1') }}</label>
                                <div class="col-sm-8">
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text"><i class="fas fa-pencil-alt"></i></span>
                        ...
                        @if (gp247_config_admin('customer_address2'))    
                            <div class="form-group row {{ $errors->has('address2') ? ' text-red' : '' }}">
                                <label for="address2" class="col-sm-2 col-form-label">{{ gp247_language_render('order.address2') }}</label>
                                <div class="col-sm-8">
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text"><i class="fas fa-pencil-alt"></i></span>
                        ...
                        <div class="form-group row {{ $errors->has('address3') ? ' text-red' : '' }}">
                            <label for="address3" class="col-sm-2 col-form-label">{{ gp247_language_render('order.address3') }}</label>
                            <div class="col-sm-8">
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text"><i class="fas fa-pencil-alt"></i></span>
                    ...
                    @endif
                        ...
                        @if (gp247_config_admin('customer_country'))
                            <div class="form-group row {{ $errors->has('country') ? ' text-red' : '' }}">
                                <label for="country" class="col-sm-2 asterisk col-form-label">{{ gp247_language_render('order.country') }}</label>
                                <div class="col-sm-8">
                        ...
                        @if (gp247_config_admin('customer_phone'))
                            <div class="form-group row  {{ $errors->has('phone') ? ' text-red' : '' }}">
                                <label for="phone" class="col-sm-2 col-form-label">{{ gp247_language_render('order.phone') }}</label>
                                <div class="col-sm-8">
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend">
                        ...
                        @endif
                            ...
                            <div class="form-group row  {{ $errors->has('currency') ? ' text-red' : '' }}">
                                <label for="currency" class="col-sm-2 asterisk col-form-label">{{ gp247_language_render('order.currency') }}</label>
                                <div class="col-sm-8">
                            ...
                            <div class="form-group row  {{ $errors->has('exchange_rate') ? ' text-red' : '' }}">
                                <label for="exchange_rate" class="col-sm-2 col-form-label">{{ gp247_language_render('order.exchange_rate') }}</label>
                                <div class="col-sm-8">
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend">
                            ...
                            <div class="form-group row">
                                <label for="comment" class="col-sm-2 col-form-label">{{ gp247_language_render('order.note') }}</label>
                                <div class="col-sm-8">
