                ...
                <div class="card-header with-border">
                    ...
                    <div class="card-tools">
                        <div class="btn-group float-right mr-5">
                            <a href="{{ gp247_route_admin('admin_subscribe.index') }}" class="btn  btn-flat btn-default" title="List"><i class="fa fa-list"></i><span class="hidden-xs"> {{ gp247_language_render('admin.back_list') }}</span></a>
                        </div>
                    </div>
                </div>
                <!-- /.card-header -->
                    ...
                    <div class="card-body">
                        <div class="fields-group">
                            ...
                            <div class="form-group  row {{ $errors->has('email') ? ' text-red' : '' }}">
                                <label for="email" class="col-sm-2 col-form-label">{{ gp247_language_render('admin.subscribe.email') }}</label>
                                <div class="col-sm-8">
                            ...
                            <div class="form-group row ">
                                <label for="status" class="col-sm-2 col-form-label">{{ gp247_language_render('admin.subscribe.status') }}</label>
                                <div class="col-sm-8">
