                ...
                <div class="card-header with-border">
                    ...
                    <div class="card-tools">
                        <div class="btn-group float-right mr-5">
                            <a href="{{ gp247_route_admin('admin_currency.index') }}" class="btn  btn-flat btn-default" title="List"><i class="fa fa-list"></i><span class="hidden-xs"> {{ gp247_language_render('admin.back_list') }}</span></a>
                        </div>
                    </div>
                </div>
                <!-- /.card-header -->
                    ...
                    <div class="card-body">
                        <div class="fields-group">
                            ...
                            <div class="form-group row  {{ $errors->has('name') ? ' text-red' : '' }}">
                                <label for="name" class="col-sm-2 col-form-label">{{ gp247_language_render('admin.currency.name') }}</label>
                                <div class="col-sm-8">
                            ...
                            <div class="form-group row  {{ $errors->has('code') ? ' text-red' : '' }}">
                                <label for="code" class="col-sm-2 col-form-label">{{ gp247_language_render('admin.currency.code') }}</label>
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                        <span class="input-group-text"><i class="fas fa-pencil-alt"></i></span>
                            ...
                            <div class="form-group row  {{ $errors->has('symbol') ? ' text-red' : '' }}">
                                <label for="symbol" class="col-sm-2 col-form-label">{{ gp247_language_render('admin.currency.symbol') }}</label>
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                        <span class="input-group-text"><i class="fas fa-pencil-alt"></i></span>
                            ...
                            <div class="form-group row  {{ $errors->has('exchange_rate') ? ' text-red' : '' }}">
                                <label for="exchange_rate" class="col-sm-2 col-form-label">{{ gp247_language_render('admin.currency.exchange_rate') }}</label>
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                        <span class="input-group-text"><i class="fas fa-pencil-alt"></i></span>
                            ...
                            <div class="form-group row  {{ $errors->has('precision') ? ' text-red' : '' }}">
                                <label for="precision" class="col-sm-2 col-form-label">{{ gp247_language_render('admin.currency.precision') }}</label>
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                        <span class="input-group-text"><i class="fas fa-pencil-alt"></i></span>
                            ...
                            <div class="form-group row {{ $errors->has('symbol_first') ? ' text-red' : '' }}">
                                <label for="symbol_first" class="col-sm-2 col-form-label">{{ gp247_language_render('admin.currency.symbol_first') }}</label>
                                <div class="col-sm-8">
                            ...
                            <div class="form-group row  {{ $errors->has('thousands') ? ' text-red' : '' }}">
                                <label for="thousands" class="col-sm-2 col-form-label">{{ gp247_language_render('admin.currency.thousands') }}</label>
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                        <span class="input-group-text"><i class="fas fa-pencil-alt"></i></span>
                            ...
                            <div class="form-group row  {{ $errors->has('sort') ? ' text-red' : '' }}">
                                <label for="sort" class="col-sm-2 col-form-label">{{ gp247_language_render('admin.currency.sort') }}</label>
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                        <span class="input-group-text"><i class="fas fa-pencil-alt"></i></span>
                            ...
                            <div class="form-group row">
                                <label for="status" class="col-sm-2 col-form-label">{{ gp247_language_render('admin.currency.status') }}</label>
                                <div class="col-sm-8">
