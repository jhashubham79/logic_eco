          ...
          <div class="box-body table-responsive">
            <section id="pjax-container" class="table-list">
                <div class="card-body table-responsivep-0" >
                  <form action="{{ gp247_route_admin('admin_language_manager.index') }}" method="GET">
                        ...
                        <div class="input-group float-left ml-1">
                          ...
                          <div class="btn-group">
                            <select class="form-control form-control-sm select2" name="lang">
                              <option value="">{{ gp247_language_render('admin.language.select_lang') }}</option>
                              @php
                                  $lang = $lang ?? 'en';
                              @endphp
                          ...
                          &nbsp; 
                          <div class="btn-group">
                            <a href="{{ gp247_route_admin('admin_language_manager.add') }}"><button type="button" class="btn btn-sm btn-success"><i class="fa fa-plus"></i></button></a>
                        </div>
                        </div>
                      </td>
                    </tr>
                  ...
                  <table class="table table-hover box-body text-wrap table-bordered">
                      <thead class="thead-light text-nowrap">
                         <tr>
                           <th>{{ gp247_language_render('admin.language_manager.position') }}</th>
