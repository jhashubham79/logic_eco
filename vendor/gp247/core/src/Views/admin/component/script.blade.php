...
<link rel="stylesheet" href="{{ gp247_file('GP247/Core/plugin/bootstrap-select.min.css')}}">
<!-- Latest compiled and minified JavaScript -->
<script src="{{ gp247_file('GP247/Core/plugin/bootstrap-select.min.js')}}"></script>
...
(function( $ ){
      ...
      $.fn.filemanager = function(type, options) {
        ...
        this.on('click', function(e) {
          ...
          var route_prefix = (options && options.prefix) ? options.prefix : '{{ gp247_route_admin('admin.home').'/'.config('lfm.url_prefix') }}';
          var target_input = $('#' + $(this).data('input'));
          var target_preview = $('#' + $(this).data('preview'));
          window.open(route_prefix + '?type=' + type, '{{ gp247_language_render('admin.file_manager') }}', 'width=900,height=600');
