                ...
                <div class="form_content" id="collapseExample">
                    ...
                    <div class="form-group{{ $errors->has('first_name') ? ' has-error' : '' }}">
                        <input type="text"
                            ...
                            name="first_name" placeholder="{{ gp247_language_render('customer.first_name') }}"
                    ...
                    <div class="form-group{{ $errors->has('last_name') ? ' has-error' : '' }}">
                        <input type="text"
                            ...
                            name="last_name" placeholder="{{ gp247_language_render('customer.last_name') }}" value="{{ old('last_name') }}">
                    ...
                    <div class="form-group{{ $errors->has('first_name') ? ' has-error' : '' }}">
                        <input type="text"
                            class="is_required validate account_input form-control {{ ($errors->has('first_name'))?"input-error":"" }}"
                            name="first_name" placeholder="{{ gp247_language_render('customer.name') }}" value="{{ old('first_name') }}">
                        @if ($errors->has('first_name'))
                        <span class="help-block">
                            {{ $errors->first('first_name') }}
                        </span>
                    ...
                    <div class="form-group{{ $errors->has('first_name_kana') ? ' has-error' : '' }}">
                        <input type="text"
                            ...
                            name="first_name_kana" placeholder="{{ gp247_language_render('customer.first_name_kana') }}"
                    ...
                    <div class="form-group{{ $errors->has('last_name_kana') ? ' has-error' : '' }}">
                        <input type="text"
                            ...
                            name="last_name_kana" placeholder="{{ gp247_language_render('customer.last_name_kana') }}" value="{{ old('last_name_kana') }}">
                    ...
                    <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                        <input type="text"
                            ...
                            name="email" placeholder="{{ gp247_language_render('customer.email') }}" value="{{ old('email') }}">
                        @if ($errors->has('email'))
                        <span class="help-block">
                            {{ $errors->first('email') }}
                        </span>
                    ...
                    <div class="form-group{{ $errors->has('phone') ? ' has-error' : '' }}">
                        <input type="text"
                            ...
                            name="phone" placeholder="{{ gp247_language_render('customer.phone') }}" value="{{ old('phone') }}">
                        @if ($errors->has('phone'))
                        <span class="help-block">
                            {{ $errors->first('phone') }}
                        </span>
                    ...
                    <div class="form-group{{ $errors->has('postcode') ? ' has-error' : '' }}">
                        <input type="text"
                            ...
                            name="postcode" placeholder="{{ gp247_language_render('customer.postcode') }}" value="{{ old('postcode') }}">
                    ...
                    <div class="form-group{{ $errors->has('address1') ? ' has-error' : '' }}">
                        <input type="text"
                            ...
                            name="address1" placeholder="{{ gp247_language_render('customer.address1') }}" value="{{ old('address1') }}">
                    ...
                    <div class="form-group{{ $errors->has('address2') ? ' has-error' : '' }}">
                        <input type="text"
                            ...
                            name="address2" placeholder="{{ gp247_language_render('customer.address2') }}" value="{{ old('address2') }}">
                    ...
                    <div class="form-group{{ $errors->has('address3') ? ' has-error' : '' }}">
                        <input type="text"
                            ...
                            name="address3" placeholder="{{ gp247_language_render('customer.address3') }}" value="{{ old('address3') }}">
                    ...
                    <div class="form-group{{ $errors->has('company') ? ' has-error' : '' }}">
                        <input type="text"
                            ...
                            name="company" placeholder="{{ gp247_language_render('customer.company') }}" value="{{ old('company') }}">
                    ...
                    <div class="form-group{{ $errors->has('sex') ? ' has-error' : '' }}">
                        <label
                            class="validate account_input {{ ($errors->has('sex'))?"input-error":"" }}">{{ gp247_language_render('customer.sex') }}:
                        </label>
                        <label class="radio-inline"><input value="0" type="radio" name="sex"
                                {{ (old('sex') == 0)?'checked':'' }}> {{ gp247_language_render('customer.sex_women') }}</label>
                        <label class="radio-inline"><input value="1" type="radio" name="sex"
                                {{ (old('sex') == 1)?'checked':'' }}> {{ gp247_language_render('customer.sex_men') }}</label>
                        @if ($errors->has('sex'))
                        <span class="help-block">
                            {{ $errors->first('sex') }}
                        </span>
                    ...
                    <div class="form-group{{ $errors->has('birthday') ? ' has-error' : '' }}">
                        <input type="date"
                            ...
                            name="birthday" data-date-format="YYYY-MM-DD" placeholder="{{ gp247_language_render('customer.birthday') }}"
                    ...
                    <div class="form-group{{ $errors->has('group') ? ' has-error' : '' }}">
                        <input type="text"
                            ...
                            name="group" placeholder="{{ gp247_language_render('customer.group') }}" value="{{ old('group') }}">
                        @if ($errors->has('group'))
                        <span class="help-block">
                            {{ $errors->first('group') }}
                        </span>
                ...
                {{-- //Custom fields --}}
                    ...
                    <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
                        <input type="password"
                            ...
                            name="password" placeholder="{{ gp247_language_render('customer.password') }}" value="">
                    ...
                    <div class="form-group{{ $errors->has('password_confirmation') ? ' has-error' : '' }}">
                        <input type="password"
                            ...
                            placeholder="{{ gp247_language_render('customer.password_confirm') }}" name="password_confirmation" value="">
