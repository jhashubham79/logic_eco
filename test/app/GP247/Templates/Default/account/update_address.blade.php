...
<h3 class="title-store">{{ $title }}</h3>
        <form method="POST" action="{{ gp247_route_front('customer.post_update_address', ['id' => $address->id]) }}">
            @csrf
            ...
            <div class="form-group row">
                <label for="default"
                    class="col-md-4 col-form-label text-md-right">{{ gp247_language_render('customer.address_set_default') }}</label>
                <div class="col-md-6">
