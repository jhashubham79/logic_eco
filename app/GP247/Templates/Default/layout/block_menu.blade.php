        ...
        @if (gp247_config('link_cart', null, 1) && function_exists('gp247_cart'))
            <li class="nav-item d-none d-lg-block">
                <a href="{{ gp247_route_front('cart') }}" class="btn btn-white position-relative">
                    ...
                    <span class="position-absolute top-0 start-100 translate-middle badge text-danger   count gp247-cart" id="shopping-cart">
            ...
            <li class="nav-item d-lg-none">
                <a href="{{ gp247_route_front('cart') }}" class="btn btn-white position-relative">
                    ...
                    <span class="position-absolute top-0 end-0 translate-middle badge text-danger count gp247-cart">
                        {{ gp247_cart()->instance('default')->count() }}
                    </span>
                </a>
            </li>
