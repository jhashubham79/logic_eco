 ...
 <section class="hero-section">
    ...
    <div class="video-wrapper">
      <video autoplay muted loop>
        <source src="{{url('images/wave-bg.mp4')}}" type="video/mp4">
      </video>
    </div>
  </section>
          ...
          <div class="simple-border">
            <div class="row pd-40 mgap">
              ...
              <div class="col-md-4 col-sm-12">
                <div class="step-item stepBoxWrap">
                  <div class="stepBox">
                    <img src="{{url('images/step2.webp')}}" class="step-icon" alt="Step 2">
                    <div class="steptxt">
              ...
              <div class="col-md-4 col-sm-12">
                <div class="step-item stepBoxWrap">
                  <div class="stepBox">
                    <img src="{{url('images/step3.webp')}}" class="step-icon" alt="Step 3">
                    <div class="steptxt">
